...
/users/RichardStebbing/bin/python solve_multiple_shards.py examples/lichtenstein_150x111.png lichtenstein_150x111_white_4.0_0.3_1000_10_update-colours white 4.0 0.3 1000 --maxiter 10 --update-colours
